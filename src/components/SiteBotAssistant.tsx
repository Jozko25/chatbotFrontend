...
function generateAssistantResponse(message: string, mode: 'landing' | 'dashboard', chatbotId?: string): Message {
  ...
  switch (intent) {
    case 'greeting':
      if (mode === 'landing') {
        baseResponse.content = `Hello! I can help you learn about SiteBot. Ask me anything about features, pricing, or how it works.`;
      } else {
    ...
    case 'features':
      ...
      baseResponse.content = `SiteBot includes the following features:\n\n${featureList}`;
      if (mode === 'landing') {
    ...
    case 'help':
      if (mode === 'dashboard') {
        ...
        baseResponse.content = `I can help with questions about SiteBot. Common topics: features, how it works, and pricing.`;
      }
      break;
    ...
    default:
      ...
      if (mode === 'dashboard') {
        ...
        baseResponse.content = `I'm not sure I understand. Try asking about SiteBot's features, how it works, or pricing.`;
      }
  }
...
function createWelcomeMessage(mode: 'landing' | 'dashboard'): Message {
  return {
    ...
    content: mode === 'landing'
      ? "Hello! I can help you learn about SiteBot. Ask me about features, pricing, or how to get started."
