...
function generateAssistantResponse(message: string, mode: 'landing' | 'dashboard', chatbotId?: string): Message {
  ...
  switch (intent) {
    case 'greeting':
      if (mode === 'landing') {
        baseResponse.content = `Hey! I'm here to help you learn about SiteBot. Ask me anything - how it works, what features we have, pricing, whatever you need.`;
      } else {
    ...
    case 'features':
      ...
      baseResponse.content = `Here's what SiteBot can do:\n\n${featureList}`;
      if (mode === 'landing') {
    ...
    case 'help':
      if (mode === 'dashboard') {
        ...
        baseResponse.content = `I can help with anything about SiteBot - just ask! Common questions: How does it work? What features are included? How much does it cost?`;
      }
      break;
    ...
    default:
      ...
      if (mode === 'dashboard') {
        ...
        baseResponse.content = `I'm not sure I follow. Try asking about SiteBot's features, how it works, or pricing - I'm happy to help with any of that.`;
      }
  }
...
function createWelcomeMessage(mode: 'landing' | 'dashboard'): Message {
  return {
    ...
    content: mode === 'landing'
      ? "Hey! I'm here to answer any questions about SiteBot. Ask me about features, pricing, how it works - whatever you need."
